      ...
      <section className="section-pricing" id="pricing">
        ...
        <div className="container grid grid--4-cols">
          <div className="feature">
            <ion-icon id="feature-icon" name="infinite-outline" />
          ...
          <div className="feature">
            <ion-icon id="feature-icon" name="nutrition-outline" />
          ...
          <div className="feature">
            <ion-icon id="feature-icon" name="leaf-outline" />
          ...
          <div className="feature">
            <ion-icon id="feature-icon" name="pause-outline" />
